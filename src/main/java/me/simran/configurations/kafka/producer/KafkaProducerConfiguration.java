package me.simran.configurations.kafka.producer;
...
public class KafkaProducerConfiguration {
     ...
     */
    @Bean
    public ProducerFactory<String, EmployeePerformance> producerFactoryString() throws UnknownHostException {
        ...
        DefaultKafkaProducerFactory<String, EmployeePerformance> factory = new DefaultKafkaProducerFactory<>(configProps);
    ...
    @Bean
    public KafkaTemplate<String, EmployeePerformance> kafkaTemplateJson() throws UnknownHostException {
